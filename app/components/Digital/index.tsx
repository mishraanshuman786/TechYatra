            ...
            <div className='mx-auto max-w-7xl px-4 my-40 pb-20 lg:pb-40 lg:px-8 bg-digital rounded-3xl bg-blue relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                    ...
                    <div className="pt-24 lg:pl-24 ">
                        ...
                        <h4 className="text-4xl sm:text-6xl font-bold text-white mb-8 leading-snug text-center lg:text-start">Your tech partner   <br /> for websites, apps, <br /> and IT solutions.</h4>
